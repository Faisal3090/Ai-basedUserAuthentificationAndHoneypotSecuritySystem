...
import { collectRealMeta, collectAttackMeta } from '../services/deviceFingerprint';
...
export default function Login({ onLoginComplete }) {
    ...
    const S = {
        ...
        card: { background: "rgba(0,20,10,0.92)", border: "1px solid #1a3a2a", borderTop: "2px solid #00ff64", padding: 24, width: "100%", maxWidth: 450 },
    };

    return (
        <div style={S.page}>
            <div style={S.grid} />
            <div style={{ width: "min(480px,96vw)", position: "relative", zIndex: 10, padding: 16 }}>
