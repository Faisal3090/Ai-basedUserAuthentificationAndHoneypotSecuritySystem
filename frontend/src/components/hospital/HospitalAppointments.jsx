    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="grid gap-4">
        {appointments.map((apt, i) => (
          <div key={i} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between hover:shadow-md transition-all group">
            ...
            <div className="flex items-center gap-6">
               ...
               <button className="w-10 h-10 rounded-full flex items-center justify-center text-slate-300 hover:bg-slate-50 hover:text-slate-900 transition-all">
